    ...
    return (
        <div className="h-full px-7 py-5 overflow-auto max-md:px-2 max-md:py-2">
            ...
            <div className="flex w-full mb-3 gap-2">
                {/* 최근 게시물 */}
                <div className="w-3/5 h-25">
                    <div className="inline-block relative font-ginto font-semibold text-xs text-[#459ebe] tracking-wide">
                        <span>Updated news</span>
                        <span className="absolute font-ginto font-light text-[8px] text-gray-400 tracking-wide -right-14.25 top-0.75">TODAY STORY</span>
                    </div>
                                ...
                                <td className="border border-gray-300 px-1">
                                    <Link href="/cy/jukebox" className="inline-block mr-1">쥬크박스 {contentCount.jukebox.today}/{contentCount.jukebox.total}</Link>
                                    {
                                        contentCount.jukebox.today > 0 ?
                                            <Image src="/images/cy/home/new.png" className="inline-block mb-0.5" width={14} height={14} alt="" />
                                            :
                                            <></>
                                    }
                                </td>
            ...
            {/* 하단 */}
            <div className="w-full h-75 max-md:h-auto">
                <div className="inline-block relative font-ginto font-semibold text-xs text-[#459ebe] tracking-wide">
                    <span>What friends say</span>
                    <span className="absolute font-diary text-[10px] text-gray-500 -right-18.25 top-0.75">한마디로 표현해</span>
                    <span className="absolute font-diary text-[10px] text-gray-500 -right-20.75 top-px">봐</span>
                    <span className="absolute font-dotum text-[15px] text-gray-500 -right-22.75 -top-0.75">~</span>
                </div>
                <hr className="border-gray-300" />
