...
export default function Calendar({
  ...
  const cells = useMemo(
    () => buildMonthCells(viewYear, viewMonth, today),
  ...
  const isSelected = (cell: CalendarCell) =>
    cell.date != null && cell.date.toDateString() === selectedDate.toDateString();

  return (
    <div className="w-full rounded-[10px] border border-zinc-300 bg-white p-4 shadow-sm">
