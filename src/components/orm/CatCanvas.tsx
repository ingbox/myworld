        ...
        <section id="canvas" className="mb-16 px-8 mx-auto">
            ...
            <div className="bg-slate-800/60 border border-slate-700 rounded-xl p-4 mb-6 font-mono text-sm">
                ...
                <div className="mt-2 text-xs text-slate-500">
                    catId=<span className="text-amber-400">{reference?.id ?? "null"}</span>
                    {" "}score=<span className="text-emerald-400">CLIP</span>
                    {" "}file=<span className="text-violet-300">image/png</span>
                </div>
            </div>
