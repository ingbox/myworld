...
import { getPathPoint } from "@/src/util/cy/profile/intro/history/path";
import {
  JOURNEY_STAGES,
  stageHeight,
  stageOpacity,
  stagePosFromX,
} from "@/src/util/cy/profile/intro/history/stages";

const BG_SRC = "/images/cy/profile/intro/history/journey-bg-wide.png";
